...
create table Hizkuntza(
	IDHizkuntza enum('ES', 'EU', 'EN', 'FR', 'DE', 'CA', 'GA', 'AR') not null primary key,
...
create table bezeroa(
    ...
    foreign key (Hizkuntza) references  Hizkuntza (IDHizkuntza) on update cascade on delete cascade
);
